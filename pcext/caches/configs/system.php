...
'cookie_pre' => 'rdmbD_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://www.rcgy.cc/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://www.rcgy.cc/statics/js/', //CDN JS
'css_path' => 'http://www.rcgy.cc/statics/css/', //CDN CSS
'img_path' => 'http://www.rcgy.cc/statics/images/', //CDN img
'app_path' => 'http://www.rcgy.cc/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'cMVNh7RLUKXnCF14iq60', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://www.rcgy.cc/phpsso_server',	//接口地址
'phpsso_auth_key' => 'HlLQiRRK8Vb9uLZrTXnaXntGGR0aqZGp', //加密密钥
