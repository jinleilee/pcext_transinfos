...
<div class="subnav">
    <div class="content-menu ib-a blue line-x">
		<a class="add fb" href=""><em><?php if($this->jxscache['iscenter']){ echo '经销商列表'; }else{ echo '瑞沃官方网站'; } ?></em></a>　  
...
<div class="table-list">
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
            <th width="10%"  align="center"><?php if($this->jxscache['iscenter']){ ?>ID<?php }?></th>
			<th width="30%">点击获取可采集栏目列表</th>
            <th width="30%"><?php if($this->jxscache['iscenter']){ echo '经销商名称'; } ?></th>
            </tr>
        </thead>
    <tbody>
 <?php 
if(is_array($jxsinfos)){
	foreach($jxsinfos as $jxs){
?>   
	<tr>
	<td width="10%"  align="center"><?php if($this->jxscache['iscenter']){ echo $jxs['jxs_id']; } ?></td>
	<td  width="30%" align="center">
    	<a href="<?php echo $jxs['url4cats']; ?>" target="_self">点击获取<strong style="color:#930;"><?php echo $jxs['jxs_name'];?></strong>可浏览栏目</a>
    </td>
	<td width="30%" align="center"><?php if($this->jxscache['iscenter']){  echo $jxs['jxs_name']; } ?></td>
	</tr>
<?php 
	}
}
