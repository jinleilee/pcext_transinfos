...
<tr>
     <th><?php echo '是否可采集';?>：</th>
      <td>
	  <input type='radio' name='info[istransful]' value='1' <?php if($istransful==1) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='info[istransful]' value='0' <?php if($istransful==0) echo 'checked';?>> <?php echo L('no');?></td>
    </tr>
